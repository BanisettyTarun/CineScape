  ...
  return (
    ...
    `}</style>
      <div className="items-center justify-between">
        ...
        <div className="hidden md:mt-3 lg:mt-0 md:flex md:px-7 md:justify-between md:items-center lg:px-10"><h1 className="text-[#A6E02C] text-xl font-semibold lg:text-2xl">Popular {category.split("_").map(word => word.charAt(0).toUpperCase() + word.slice(1).toLowerCase())  // Capitalize first letter of each word
          ...
          <div className="hidden md:flex gap-2">
              <DropDown title="Category" options={["tv", "movie"]} setOption={setCategory} />
          </div>
        </div>
      </div>
      ...
      <div className="flex  justify-center md:hidden px-3"><h1 className="text-[#A6E02C] text-lg w-fit md:text-xl font-semibold">Popular {category.split("_").map(word => word.charAt(0).toUpperCase() + word.slice(1).toLowerCase())  // Capitalize first letter of each word
        .join(" ") === "Tv" ? "TV Shows" : category.split("_").map(word => word.charAt(0).toUpperCase() + word.slice(1).toLowerCase())  // Capitalize first letter of each word
